...
Pienen tauon jälkeen siirryin seuraavan tehtävän kimppuun klo 19:19. 

Ensimmäisenä varmistin olevani edelleen "koti"kansiossa, ja listasin mitä kansioita ja tiedostoja se pitää sisällään.

![image](https://github.com/user-attachments/assets/a4ba6750-c92a-4ea9-a7fe-0ad014627526)

Seuraavana "juuri"kansio, johon päästiin yhden virhekomennon jälkeen.
