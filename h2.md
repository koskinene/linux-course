...
Pienen tauon jälkeen siirryin seuraavan tehtävän kimppuun klo 19:19. Lähteenä kansioiden hakuun käytin taasen Teron ohjetta (lähde: https://terokarvinen.com/2020/command-line-basics-revisited/).
...
Luin "man grep" -komennolla lisää grepistä, ja oikean komennon löytyminen tapahtui yrityksen ja erehdyksen kautta.
